...
def listar_tarefas(lista):
    ...
    # Como a inserção é no início, o primeiro cadastrado foi empurrado para o fim da lista.
    # Para listar na ordem original de cadastro (cronológica), navegamos até o fim e voltamos usando o ponteiro 'anterior'.
    aux = lista
